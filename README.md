...
* [glTF 2.0 specification](https://registry.khronos.org/glTF/specs/2.0/glTF-2.0.html) - has much about normals textures. I [filed a pull request](https://github.com/KhronosGroup/glTF-Sample-Assets/pull/114) submitting a large number of fixed normals textures for the glTF Sample Assets repository.
* [USD Normals Texture Bias And Scale](https://github.com/usd-wg/assets/tree/main/test_assets/NormalsTextureBiasAndScale) - a set of test normals textures of different types in a USD file, along with copious documentation of how each cube is formed. I made this test. For USD, I [filed a bug](https://github.com/PixarAnimationStudios/OpenUSD/issues/3013) reporting that one (of the two) normalMap.png images in the OpenUSD repository is off.
